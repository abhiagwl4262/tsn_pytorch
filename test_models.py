...
parser.add_argument('--dataset', type=str, choices=['ucf101', 'hmdb51', 'kinetics', 'anomaly'])
...
data_loader = torch.utils.data.DataLoader(
        TSNDataSet("", args.test_list, num_segments=args.test_segments,
                   ...
                   image_tmpl="{:05d}.png" if args.modality in ['RGB', 'RGBDiff'] else args.flow_prefix+"{}_{:05d}.png",
                   test_mode=True,
